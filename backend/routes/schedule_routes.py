...
@router.post("/dep-check")
async def run_dep_check() -> dict:
    """Trigger an on-demand dependency health check (CVEs, outdated, consistency)."""
    from backend.agents.dep_checker import run_full_check
