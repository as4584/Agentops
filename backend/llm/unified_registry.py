...
UNIFIED_MODEL_REGISTRY: dict[str, ModelSpec] = {
    ...
    # Sprint 1: new local models for role-based routing
    "qwen2.5:3b": ModelSpec(
        ...
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["routing", "classification", "fast_qa"],
        fallback_chain=["llama3.2:1b", "llama3.2"],
    ...
    "qwen2.5-coder:7b": ModelSpec(
        ...
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["code_generation", "tool_calling", "agent_execution"],
        fallback_chain=["mistral:7b", "qwen2.5"],
        supports_tools=True,
    ),
    "deepseek-r1:7b": ModelSpec(
        ...
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["deep_reasoning", "validation", "architecture_review"],
        fallback_chain=["mistral:7b", "llama3.2"],
        supports_tools=False,
    ),
    # Sprint 1: new OpenRouter free-tier cloud models
    "qwen3-coder:free": ModelSpec(
        ...
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["code_planning", "code_generation", "tool_calling"],
        fallback_chain=["qwen2.5-coder:7b", "mistral:7b"],
        supports_tools=True,
    ),
    "gemma-3-27b-it:free": ModelSpec(
        ...
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["planning", "reasoning", "architecture_analysis"],
        fallback_chain=["kimi-k2", "llama-3.3-70b:free"],
        supports_tools=True,
    ),
    "deepseek-r1:free": ModelSpec(
        ...
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["deep_reasoning", "validation", "high_risk_review"],
        fallback_chain=["deepseek-r1:7b", "kimi-k2-thinking"],
        supports_tools=False,
    ),
    "llama-3.3-70b:free": ModelSpec(
        model_id="llama-3.3-70b:free",
        provider=ModelProvider.OPENROUTER,
        display_name="Llama 3.3 70B (free)",
        context_window=131072,
        input_cost_per_m=0.0,
        output_cost_per_m=0.0,
        best_for=["general", "summarization", "reasoning"],
...
DEFAULT_TASK_MODELS: dict[str, str] = {
    # Legacy task keys (kept for backward compatibility)
    "routing": "llama3.2:1b",
