...
class TestRubricScorer:
    def test_all_criteria_met(self) -> None:
        scorer = RubricScorer(criteria=[
            {"name": "contains_hello", "description": "Must contain hello", "check_type": "contains", "check_value": "hello"},
    ...
    def test_partial_criteria(self) -> None:
        scorer = RubricScorer(criteria=[
            {"name": "has_hello", "description": "Must contain hello", "check_type": "contains", "check_value": "hello", "weight": 1.0},
            {"name": "has_goodbye", "description": "Must contain goodbye", "check_type": "contains", "check_value": "goodbye", "weight": 1.0},
        ])
    ...
    def test_regex_criterion(self) -> None:
        scorer = RubricScorer(criteria=[
            {"name": "has_number", "description": "Must contain number", "check_type": "regex", "check_value": r"\d+"},
        ])
    ...
    def test_not_contains_criterion(self) -> None:
        scorer = RubricScorer(criteria=[
            {"name": "no_error", "description": "Must not contain error", "check_type": "not_contains", "check_value": "error"},
        ])
    ...
    def test_keyword_count(self) -> None:
        scorer = RubricScorer(criteria=[
            {"name": "keywords", "description": "Must contain keywords", "check_type": "keyword_count", "check_value": ["python", "fastapi"]},
        ])
...
class TestGoldenTaskRegistry:
    ...
    def test_list_tasks(self, registry: GoldenTaskRegistry) -> None:
        registry.add_task({
            "task_id": "t1", "task_type": "classification",
            "description": "d1", "input_prompt": "p1", "expected_output": "o1",
        })
        registry.add_task({
            "task_id": "t2", "task_type": "extraction",
            "description": "d2", "input_prompt": "p2", "expected_output": "o2",
        })
    ...
    def test_remove_task(self, registry: GoldenTaskRegistry) -> None:
        registry.add_task({
            "task_id": "rm1", "task_type": "test",
            "description": "d", "input_prompt": "p", "expected_output": "o",
        })
    ...
    def test_score_against_golden(self, registry: GoldenTaskRegistry) -> None:
        registry.add_task({
            "task_id": "score1", "task_type": "test",
            "description": "d", "input_prompt": "p", "expected_output": "correct answer",
        })
    ...
    def test_score_with_rubric(self, registry: GoldenTaskRegistry) -> None:
        registry.add_task({
            "task_id": "rubric1", "task_type": "test",
            "description": "d", "input_prompt": "p", "expected_output": "expected",
            "scoring_method": "rubric",
            "rubric_criteria": [
                {"name": "has_keyword", "description": "Contains hello", "check_type": "contains", "check_value": "hello"},
            ],
        })
    ...
    def test_list_by_difficulty(self, registry: GoldenTaskRegistry) -> None:
        registry.add_task({
            "task_id": "easy1", "task_type": "test", "difficulty": "easy",
            "description": "d", "input_prompt": "p", "expected_output": "o",
        })
        registry.add_task({
            "task_id": "hard1", "task_type": "test", "difficulty": "hard",
            "description": "d", "input_prompt": "p", "expected_output": "o",
        })
    ...
    def test_list_by_tags(self, registry: GoldenTaskRegistry) -> None:
        registry.add_task({
            "task_id": "tagged1", "task_type": "test", "tags": ["python", "async"],
            "description": "d", "input_prompt": "p", "expected_output": "o",
        })
    ...
    def test_persistence(self, tmp_path: Path) -> None:
        ...
        r1.add_task({
            "task_id": "persist1", "task_type": "test",
            "description": "d", "input_prompt": "p", "expected_output": "o",
        })
